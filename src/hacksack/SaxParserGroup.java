...
public class SaxParserGroup extends DefaultHandler {
  ...
  public static void loadUp(HackSackFrame oThis, String sFileName,boolean bFullPath) {
    ...
    try {
      ...
      SaxParserGroup SaxParserGroupInstance = new SaxParserGroup();
      SAXParser parser = parserFactory.newSAXParser();
      parser.parse(url, SaxParserGroupInstance);
    }
    catch (IOException ex) {
      oParent.gmLog(true, false, "IOException in SaxXMLParser.loadUP() on file "+sFileName+"("+ex.getMessage()+")\n");
      ex.printStackTrace();
    }
    catch (SAXException ex) {
      oParent.gmLog(true, false, "SAXException in SaxXMLParser.loadUP() on file "+sFileName+"("+ex.getMessage()+")\n");
      ex.printStackTrace();
    }
    catch (ParserConfigurationException ex) {
      oParent.gmLog(true, false,
                    "ParserConfigurationException in SaxXMLParser.loadUP() on file "+sFileName+"("+ex.getMessage()+")\n");
      ex.printStackTrace();
    }
    catch (FactoryConfigurationError ex) {
      oParent.gmLog(true, false,
                    "FactoryConfigurationError in SaxXMLParser.loadUP() on file "+sFileName+"("+ex.getMessage()+")\n");
      ex.printStackTrace();
    }
...
//      oParent.gplPlayer = oNew;
    ...
    if (qName.equalsIgnoreCase("Timer")) {
      oParent.gplGroupLog.lTimers.add(oT);
    }

    if (qName.equalsIgnoreCase("EXPAwards")) {
      oParent.gplGroupLog.lEXP.add(oE);
    }
    if (qName.equalsIgnoreCase("HonorAwards")) {
      oParent.gplGroupLog.lHonor.add(oHonor);
    }
    if (qName.equalsIgnoreCase("MonsterAwards")) {
      oParent.gplGroupLog.lMonsters.add(oMonster);
    }
...
//oParent.jGMTextArea.append("start document: ");
  ...
  public void startElement(String uri, String localName, String qName,
    ...
    if (qName.equalsIgnoreCase("GroupFile")) {
      for (int i = 0; i < attributes.getLength(); i++) {
        if (attributes.getQName(i).equalsIgnoreCase("jLog"))
        oParent.gplGroupLog.jLog.append(oParent.unEscapeChars(attributes.getValue(i)));
      if (attributes.getQName(i).equalsIgnoreCase("jYear"))
        oParent.gplGroupLog.jYear.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
      if (attributes.getQName(i).equalsIgnoreCase("jMonth"))
        oParent.gplGroupLog.jMonth.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
      if (attributes.getQName(i).equalsIgnoreCase("jDay"))
        oParent.gplGroupLog.jDay.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
      if (attributes.getQName(i).equalsIgnoreCase("jTurn"))
        oParent.gplGroupLog.jTurn.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
      if (attributes.getQName(i).equalsIgnoreCase("jRound"))
        oParent.gplGroupLog.jRound.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
      if (attributes.getQName(i).equalsIgnoreCase("jSegment"))
        oParent.gplGroupLog.jSegment.getModel().setValue(new Integer(Integer.
            parseInt(attributes.getValue(i))));
    ...
    if (qName.equalsIgnoreCase("Timer")) {
      oT = new Timer(oParent.gplGroupLog);
      for (int i = 0; i < attributes.getLength(); i++) {
        if (attributes.getQName(i).equalsIgnoreCase("sDesc"))
          oT.sDesc = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("sSetText"))
          oT.sSetText = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("lTimer"))
          oT.lTimer = Long.parseLong(attributes.getValue(i));
      }
    }

    if (qName.equalsIgnoreCase("EXPAwards")) {
      oE = new EXPAwards(oParent);
      for (int i = 0; i < attributes.getLength(); i++) {
        if (attributes.getQName(i).equalsIgnoreCase("sDetails"))
          oE.sDetails = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("nID"))
          oE.nID =Integer.parseInt(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("lIndividual"))
          oE.lIndividual =Long.parseLong(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("jApplied"))
          oE.jApplied.setSelected(attributes.getValue(i).equalsIgnoreCase("0")?false:true);
      }
    }

    if (qName.equalsIgnoreCase("HonorAwards")) {
      oHonor = new HonorAward(oParent);
      for (int i = 0; i < attributes.getLength(); i++) {
        if (attributes.getQName(i).equalsIgnoreCase("nID"))
          oHonor.nID =Integer.parseInt(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("lIndividual"))
          oHonor.lIndividual =Long.parseLong(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("sDetails"))
          oHonor.sDetails = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("jApplied"))
          oHonor.jApplied.setSelected(attributes.getValue(i).equalsIgnoreCase("0")?false:true);
      }
    }
    if (qName.equalsIgnoreCase("MonsterAwards")) {
      oMonster = new Monster(oParent);
      for (int i = 0; i < attributes.getLength(); i++) {
        if (attributes.getQName(i).equalsIgnoreCase("sName"))
          oMonster.sName = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("sDesc"))
          oMonster.sDesc = oParent.unEscapeChars(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("nEXPValue"))
          oMonster.nEXPValue =Integer.parseInt(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("nHonorValue"))
          oMonster.nHonorValue =Integer.parseInt(attributes.getValue(i));
        if (attributes.getQName(i).equalsIgnoreCase("jApplied"))
          oMonster.jApplied.setSelected(attributes.getValue(i).equalsIgnoreCase("0")?false:true);
      }
    }
    ...
    if (qName.equalsIgnoreCase("Player")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("AC_NORMAL"))
          oNew.nAC[oNew.AC_NORMAL].getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("AC_REAR"))
          oNew.nAC[oNew.AC_REAR].getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("AC_SHIELDLESS"))
          oNew.nAC[oNew.AC_SHIELDLESS].getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("AC_SUPRISED"))
          oNew.nAC[oNew.AC_SUPRISED].getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jHealthMax"))
          oNew.jHealthMax.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jMove"))
          oNew.jMove.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jHonor"))
          oNew.jHonor.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jAbsent"))
          oNew.jAbsent.setSelected(attributes.getValue(i).equalsIgnoreCase("0")?false:true);
        if (attributes.getQName(i).equalsIgnoreCase("jHireling"))
          oNew.jHireling.setSelected(attributes.getValue(i).equalsIgnoreCase("0")?false:true);
      }
    ...
    if (qName.equalsIgnoreCase("Abilities")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jAdjScore"))
          oA.jAdjScore.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jAdjPercent"))
          oA.jAdjPercent.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
      }
    ...
    if (qName.equalsIgnoreCase("Class")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jEXP"))
          oClass.jEXP.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jLevel"))
          oClass.jLevel.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
      }
    }
    ...
    if (qName.equalsIgnoreCase("Saves")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jSave"))
          oSave.jSave.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jSaveMod"))
          oSave.jSaveMod.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
        if (attributes.getQName(i).equalsIgnoreCase("jSaveOther"))
          oSave.jSaveOther.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
      }
    }
    if (qName.equalsIgnoreCase("Coins")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jCount")) {
          ...
          oCoin.jMod.setValue(new Integer(Integer.parseInt(attributes.getValue(
              i))));
        }
      }
    }
    ...
    if (qName.equalsIgnoreCase("Skills")) {
      ...
      for (int i = 0; i < attributes.getLength(); i++) {
        ...
        if (attributes.getQName(i).equalsIgnoreCase("jSkillSpinner"))
          oSkill.jSkillSpinner.getModel().setValue(new Integer(Integer.parseInt(attributes.getValue(i))));
